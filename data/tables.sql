...
INSERT INTO tbl_books (title, isbn, author, description, price) 
	VALUES ('PHP In Action', '978-1932394757', 'Dagfinn Reiersol, Chris Shiflett, Marcus Baker', 'A very great book about PHP', 35.00);
INSERT INTO tbl_books (title, isbn, author, description, price) 
	VALUES ('Spring In Action', '978-1935182351', 'Craig Walls', 'A very great book about the Spring Framework', 34.50);
INSERT INTO tbl_books (title, isbn, author, description, price) 
	VALUES ('PHP and MySQL Web Development', '978-0672329166', 'Luke Welling, Laura Thomson', 'A very great book about PHP. It is an intermediary book.', 39.99);
